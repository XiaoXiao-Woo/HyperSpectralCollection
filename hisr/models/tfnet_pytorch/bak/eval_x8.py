...
parser.add_argument('--dataset', type=str, default='F:\Data\HSI\cave_x8')
...
model = torch.load('model/tfnet_cave_x8_202212031406/model_epoch_%s.pth'%opt.checkpoint)
...
def test(test_data_loader, model):
    ...
    sio.savemat('cave11_x8-restf.mat', {'output': output})
