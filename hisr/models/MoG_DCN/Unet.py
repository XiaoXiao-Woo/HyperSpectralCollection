...
class Encoding_Block(torch.nn.Module):
    def __init__(self, c_in):
        ...
        self.conv1 = torch.nn.Conv2d(
            in_channels=c_in, out_channels=32, kernel_size=3, padding=3 // 2
        )
        ...
        self.conv5 = torch.nn.Conv2d(
            in_channels=64, out_channels=32, kernel_size=3, stride=2, padding=3 // 2
        )
...
class Decoding_Block(torch.nn.Module):
    def __init__(self, c_in):
        ...
        self.conv0 = torch.nn.Conv2d(
            in_channels=128, out_channels=64, kernel_size=3, padding=3 // 2
        )
        self.conv1 = torch.nn.Conv2d(
        ...
        self.up = torch.nn.ConvTranspose2d(
            c_in, 64, kernel_size=3, stride=2, padding=3 // 2
        )
...
class Feature_Decoding_End(torch.nn.Module):
    def __init__(self, c_out):
        ...
        self.conv3 = torch.nn.Conv2d(
            in_channels=64, out_channels=c_out, kernel_size=3, padding=3 // 2
        )
        self.batch = 1
        self.up = torch.nn.ConvTranspose2d(
            256, 64, kernel_size=3, stride=2, padding=3 // 2
        )
        self.act = torch.nn.PReLU()
        self.reset_parameters()
...
class Unet(torch.nn.Module):
    ...
    def __init__(
        self, channel, hs_channel, ms_channel, embedding_dim=32, with_feat_space=False
    ):
        super(Unet, self).__init__()

        self.Encoding_block1 = Encoding_Block(channel)
        self.Encoding_block2 = Encoding_Block(embedding_dim)
        self.Encoding_block3 = Encoding_Block(embedding_dim)
        self.Encoding_block4 = Encoding_Block(embedding_dim)
        self.Encoding_block_end = Encoding_Block_End(embedding_dim)

        self.Decoding_block1 = Decoding_Block(embedding_dim * 2)
        self.Decoding_block2 = Decoding_Block(embedding_dim * 8)
        self.Decoding_block3 = Decoding_Block(embedding_dim * 8)
