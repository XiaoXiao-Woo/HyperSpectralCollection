...
model_folder = "Trained_model/cave_x8/"
...
def test():
    test_set = DatasetFromHdf5("F:/Data/HSI/cave_x4/test_cave(with_up)x4.h5")
    ...
    sio.savemat('cave11-fusformer.mat',{'output': output_HRHSI})
###################################################################
# ------------------- Main Function  -------------------
###################################################################
if __name__ == "__main__":
    ...
    if train_or_not:
        ...
        train_set = DatasetFromHdf5('F:/Data/HSI/cave_x8/train_cave(with_up)x8_rgb_16.h5.h5')  # creat data for training
        training_data_loader = DataLoader(dataset=train_set, num_workers=0, batch_size=batch_size, shuffle=True,
                                          pin_memory=True, drop_last=True)  # put training data to DataLoader for batches
        validate_set = DatasetFromHdf5('F:/Data/HSI/cave_x8/validation_cave(with_up)x8_rgb.h5')  # creat data for validation
