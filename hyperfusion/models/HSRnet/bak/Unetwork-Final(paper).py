...
def train():
    ...
    train_data_name = './DATA/train4(20-11)(pRGB).mat'  # training data
    test_data_name = './DATA/validation4(20-11)(pRGB).mat'  # validation data
    ...
    with tf.Session() as sess:
        ...
        # file = open('train_mse_square.txt',
        #             'w')  # write the training error into train_mse.txt
        # file.write(str(mse_train))
        # file.close()
        #
        # file = open('valid_mse_square.txt', 'w')  # write the valid error into valid_mse.txt
        # file.write(str(mse_valid))
        # file.close()

        # file = open('train_time_square.txt',
        #             'w')  # write the training error into train_mse.txt
...
def test():
    ...
    test_data = 'G:\JF_Hu\DATA/test_harvard_10_v3(pRGB).mat'
    tf.reset_default_graph()
    N = 10
    sz = 1000
    ...
    [rs, CA, SA] = rgbNet(m_hp, r_hp)  # output high-frequency parts
    ...
    with tf.Session(config=config) as sess:
        ...
        sio.savemat('output-HSR(paper)(5x5)(1e-3)-harvard.mat',
            {'output': OUT})

if __name__ == '__main__':
    global model_directory
    model_directory = './3_models/HSR(paper)(5x5)(1e-3)'
    train()
    test()
