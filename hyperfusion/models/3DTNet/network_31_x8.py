...
if __name__ == '__main__':
    ...
    model = _3DT_Net(channel0=31, factor=8, patch_size=128).cuda()
    torchstat.stat(model, [[1, 31, 16, 16], [1, 3, 128, 128]])
    '''
    (first four is divided by 1000)
    Total params: 3.46M 0.0035G (3,463,535)
    --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    Total memory: 994.49MB
    Total MAdd: 51.51GMAdd 0.0515TMAdd
    Total Flops: 56.11GFlops 0.0561TFlops
    Total MemR+W: 1.69GB 0.0017TB
    '''